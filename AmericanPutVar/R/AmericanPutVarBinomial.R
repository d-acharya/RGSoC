#' Calculates VaR of American vanilla put using binomial tree. 
#' 
#' Calculates VaR of American Put Option using binomial tree to price the option
...
#' @param r Risk-free rate of returns.
...
AmericanPutVarBinomial <- function(amountInvested, stockPrice, strike, r,
  ...
  #compute VaR
  return (VaR(profitOrLoss, p=0.95, method="historical",invert=FALSE))
}